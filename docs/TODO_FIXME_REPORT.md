...
- **todo** in `launcher/minecraft/PackProfile.h`:176 — // todo(merged): is this the best approach
```
...
- **TODO** in `launcher/minecraft/PackProfile.cpp`:649 — // TODO: this will need fine-tuning later...
```
...
- **TODO** in `launcher/minecraft/PackProfile.cpp`:1091 — // TODO: remove this or add version condition once Quilt drops official Fabric support
```
        return loadersOpt;
...
- **TODO** in `launcher/minecraft/PackProfile.cpp`:1108 — // TODO: remove this or add version condition once Quilt drops official Fabric support
```
    }
...
- **FIXME** in `launcher/minecraft/PackProfile.cpp`:633 — // FIXME: zero precision mess
```
}
...
- **FIXME** in `launcher/minecraft/PackProfile.cpp`:705 — // FIXME: get rid of _internal
```
...
- **FIXME** in `launcher/minecraft/PackProfile.cpp`:711 — // FIXME: get rid of _internal
```
...
- **FIXME** in `launcher/minecraft/PackProfile.cpp`:746 — // FIXME: get rid of _internal
```
...
- **FIXME** in `launcher/minecraft/PackProfile.cpp`:940 — // FIXME code duplication
```
