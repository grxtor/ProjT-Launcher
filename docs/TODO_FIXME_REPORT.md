...
- **FIXME** in `launcher/meta/VersionList.cpp`:128 — // FIXME: this should be determined in whatever view/proxy is used...
```
            return major;
        }
...
- **TODO** in `launcher/meta/VersionList.cpp`:257 — // TODO: do not reset the whole model. maybe?
```
    }
...
- **TODO** in `launcher/minecraft/PackProfile.cpp`:1066 — // TODO: remove this or add version condition once Quilt drops official Fabric support
```
        return loadersOpt;
...
- **TODO** in `launcher/minecraft/PackProfile.cpp`:1083 — // TODO: remove this or add version condition once Quilt drops official Fabric support
```
    }
...
- **TODO** in `tools/generate_todo_report.py`:106 — f.write('# TODO/FIXME Report\n\n')
```
...
- **FIXME** in `launcher/meta/VersionList.cpp`:201 — // FIXME: this is dumb, we have 'recommended' as part of the metadata already...
```
    }
...
- **FIXME** in `launcher/meta/VersionList.cpp`:223 — // FIXME: this is dumb, we have 'recommended' as part of the metadata already...
```
}
...
- **FIXME** in `launcher/minecraft/PackProfile.cpp`:915 — // FIXME code duplication
```
